...
#  define CONF_CLOCK_XOSC_STARTUP_TIME            SYSTEM_XOSC_STARTUP_2 //maybe increase it to 32k
...
#  define CONF_CLOCK_DPLL_REFERENCE_DIVIDER       375
...
#  define CONF_CLOCK_GCLK_7_PRESCALER             100
